...
if __name__ == '__main__':
    ...
    label_strs = ['clang-Low', 'clang-High', 'gcc-Low', 'gcc-High', 'icc-Low', 'icc-High']
    hyper_log_prefix = 'earlystop-familyandbinaryoptimization'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            for model_type in model_types:
                ...
                model_name = model_type + '#earlystop-FamilyandBinaryOptimization#' + ins_abs_stgs[
                    i] + '#' + unique_fun_stg + '.h5'
