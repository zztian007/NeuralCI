...
if __name__ == '__main__':
    ...
    CLASS_NUMBER = 3
    hyper_log_prefix = 'earlystop-tripleoptimization'
        ...
        for unique_fun_stg in unique_fun_stgs:
            for model_type in model_types:
                for cp_family in cp_families:
                    label_strs = [cp_family + '-' + ver for ver in ['O0', 'O1', 'High']]
                    ...
                    model_name = model_type + '#earlystop-tripleOptimization#' + ins_abs_stgs[
