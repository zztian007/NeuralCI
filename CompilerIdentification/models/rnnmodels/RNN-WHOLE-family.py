                ...
                if line.startswith('>>>'):
                    if line.startswith('>>>Func'):
                        ...
                        if f_label in unique_funs:
                            ...
                            labels.append(label_maps[compiler_family])
                    continue
...
if __name__ == '__main__':
    ...
    label_strs = ['gcc', 'clang', 'icc']
    lr = 1e-3
    CLASS_NUMBER = len(label_maps)
    hyper_log_prefix = 'earlystop-family'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            for model_type in model_types:
                ...
                model_name = model_type + '#earlystop-family#' + ins_abs_stgs[i] + '#' + unique_fun_stg + '.h5'
