...
if __name__ == '__main__':
    ...
    # attention_types = ['attention_with_context', 'seq_weighted_attention', 'scaled_dot']
    # model_types = ['naive']
        ...
        for unique_fun_stg in unique_fun_stgs:
            for model_type in model_types:
                for att_type in attention_types:
                    ...
                    model_name = model_type + '#' + att_type + '#earlystop-FamilyandBinaryOptimization#' + ins_abs_stgs[
                        i] + '#' + unique_fun_stg + '.h5'
                    print(model_name)
