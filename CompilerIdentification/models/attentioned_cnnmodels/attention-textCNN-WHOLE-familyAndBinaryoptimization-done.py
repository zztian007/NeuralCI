...
def sess_setup():
    if not OCCUPY_ALL:
        ...
        # config.gpu_options.per_process_gpu_memory_fraction = 0.8    # grow from zero if comment out this line
...
def run_whole_procedure(fig_prefix, att_type):
    """
...
if __name__ == '__main__':
    ...
    hyper_log_prefix = 'atten-FamilyandBinaryOptimization'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            for att_type in attention_types:
                ...
                model_name = 'cp-FamilyandBinaryOptimization#' + ins_abs_stgs[i] + '#' + unique_fun_stg + '#' + att_type + '.h5'
                print('-------------------' + model_name + '-------------------')
                ...
                run_whole_procedure(model_name.replace('.h5', ''), att_type)
