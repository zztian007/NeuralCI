...
def run_whole_procedure(fig_prefix, cp_family, ver_list, att_type):
    """
...
if __name__ == '__main__':
    ...
    for cp_family in versions.keys():
        ...
        hyper_log_prefix = 'atten-minor-version'
        ...
        for i in range(len(ins_abs_stgs)):
            ...
            for unique_fun_stg in unique_fun_stgs:
                for att_type in attention_types:
                    ...
                    model_name = 'cp-minor-version#' + ins_abs_stgs[i] + '#' + unique_fun_stg + \
                    ...
                    run_whole_procedure(model_name.replace('.h5', ''), cp_family, versions[cp_family], att_type)
