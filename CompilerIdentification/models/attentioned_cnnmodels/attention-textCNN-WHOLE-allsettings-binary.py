...
def run_whole_procedure(fig_prefix, versions, att_type):
    """
...
if __name__ == '__main__':
    ...
    attention_types = ['scaled_dot', 'seq_self_attention']
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            for att_type in attention_types:
                ...
                model_name = 'cp-allSettings-binary#' + ins_abs_stgs[i] + '#' + unique_fun_stg + '#' + att_type + '.h5'
                print('-------------------' + model_name + '-------------------')
                ...
                run_whole_procedure(model_name.replace('.h5', ''), versions, att_type)
