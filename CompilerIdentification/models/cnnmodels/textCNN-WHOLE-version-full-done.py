...
def run_whole_procedure(fig_prefix, cp_family, ver_list):
    """
    ...
    for cp_family in versions.keys():
        ...
        for i in range(len(ins_abs_stgs)):
            ...
            for unique_fun_stg in unique_fun_stgs:
                ...
                model_name = 'cp-major-version#' + ins_abs_stgs[i] + '#' + unique_fun_stg + \
                             '#' + cp_family + '.h5'
                print('-------------------' + model_name + '-------------------')
                ...
                run_whole_procedure(model_name.replace('.h5', ''), cp_family, versions[cp_family])
