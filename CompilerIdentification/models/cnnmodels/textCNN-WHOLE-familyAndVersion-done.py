...
def run_whole_procedure(fig_prefix, versions):
    """
...
if __name__ == '__main__':
    ...
    hyper_log_prefix = 'xxxx-familyAndVersion'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            ...
            model_name = 'cp-familyandversion#' + ins_abs_stgs[i] + '#' + unique_fun_stg + '.h5'
            print('-------------------' + model_name + '-------------------')
            ...
            run_whole_procedure(model_name.replace('.h5', ''), versions)
